# [Hyperspatial Engineering 1] 3Dangerous Commute

Version 1.0

1.0 - Finalised challenge.

---

**Misc/Scripting -- Hard (7) -- Author(s): Polymero**


_"After some time in workforce-hibernation (aka unemployed), you have received an offer for a job interview. There is just one problem, it is at the other end of the Universe! Luckily you know your way around the HyperSpace, \*ehem\* nerd \*mm\*."_


nc ctf.web.link 1010


Files: [dangerouscommute.py](dangerouscommute.py)
...
# mincost, minpath = PRIVATE.solve_MCP(hs.zonemap, hs.minemap)
# print('Solution path:', minpath)
# print()

# hs.check_win(minpath)
```